...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'project-manager', 'developer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Project', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Task', path: '/tasks', entity: 'task', service: AccessServiceEnum.PROJECT, icon: FiBox },
